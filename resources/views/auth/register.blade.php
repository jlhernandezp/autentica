                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="expediente" type="text" class="form-control{{ $errors->has('expediente') ? ' is-invalid' : '' }}" name="expediente" value="{{ old('expediente') }}" required autofocus>
                            ...
                            <span class="col-md-4"> </span>
                                <div class="radio col-md-6">
                                    <label class="radio-inline">
                                        <input type="radio" class="" name="rol" value="0" checked="checked" />
                                        Alumno
                                    </label>
                                    <label class="radio-inline">
