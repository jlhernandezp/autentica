        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group">
                        <a href="{{route('evaluar')}}" class='btn btn-lg btn-info'>Evaluar TFC<span class="glyphicon glyphicon-paperclip"></span></a>
                        <a href="{{route('consulta')}}" class='btn btn-lg btn-info'>Consulta TFCs<span class="glyphicon glyphicon-list-alt"></span></a>
